...
//========================== LISTA DE PLACAS  =======================//
  ...
  void seItemAddPlaca(String? valor) {
    _itemAddPlaca = valor;
    print('item _itemAddPlaca: $_itemAddPlaca');
    notifyListeners();
  }
...
// print('LA DATA PARA IMPRIMIR COMPROBANTE $_nuevaFactura');
...
Future<dynamic> getAllFormaPago() async {
 ...
 List dataSort = [];
        ...
        dataSort.sort((a, b) => a['fpagoNombre']!.compareTo(b['fpagoNombre']!));
setListaFormasPago(dataSort);
      notifyListeners();
      return null;
    }
