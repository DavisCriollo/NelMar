...
class CabeceraFluidoHospitalizacionDTS extends DataTableSource {
  final BuildContext context;
  final List<dynamic> _listaFluidos;
  final Responsive size;
  final String? accion;
  final bool? detalle;

  CabeceraFluidoHospitalizacionDTS(
      this._listaFluidos, this.size, this.context, this.accion, this.detalle);

  final controllersHome = HospitalizacionController();
  @override
  DataRow? getRow(int index) {
    _listaFluidos
        .sort((a, b) => b['idFluido'].compareTo(a['idFluido']));
            ...
            IconButton(
              onPressed: ()  {
                ...
                //  final controller = context.read<c>();
                 final controller = Provider.of<HospitalizacionController>(context, listen: false);
                controller
                    .setNombreFluido(_listaFluidos[index]['fluido']);
                controller
                    .setDosisFluido(_listaFluidos[index]['dosis']);
                controller
                    .setCantidadFluido(_listaFluidos[index]['cantidad']);
                // controller
                //     .setViaFluido(_listaFluidos[index]['via']);
                controller
                    .setInicioFluido(_listaFluidos[index]['inicio']);
                // controller.setFrecuenciaFluido(
                //     _listaFluidos[index]['frecuencia']);
...
///===========================================//
 showDialog<bool>(
  ...
  // controller.setNombreFluido('${controller.getNombreFluido}');
          ...
          AlertDialog(
              // title:  Text(" FLUIDOS ${controller.getNombreFluido}"),
              title: Row(
                ...
                children: [
                  ...
                  IconButton(
                      ...
                      onPressed: () {
                        ...
                        // }
                        controller
                                                .getInfoRowFluido(_listaFluidos[index]['idFluido']);
                                            Navigator.pop(context);
                      },
                      ...
                      children: [
                        SizedBox(
                          ...
                          child: SingleChildScrollView(
                            ...
                            child: Form(
                              key:
                                  controllersHome.hospitalizacionFluidoFormKey,
                              child: Column(
                                children: [
                                  // //***********************************************/
                                  // SizedBox(
                                    ...
                                    children: [
                                      ...
                                      Expanded(
                                        child: Container(
                                          ...
                                          child: TextFormField(
                                            initialValue:  _listaFluidos[index]['fluido'],
                                    ...
                                    children: [
                                      ...
                                      Expanded(
                                        child: Container(
                                          // width: size.wScreen(20.0),
                                          child: TextFormField(
                                            initialValue: _listaFluidos[index]['dosis'],
                                            // keyboardType: TextInputType.number,
                                            // inputFormatters: <TextInputFormatter>[
                                            //   FilteringTextInputFormatter.allow(
                                            //       RegExp(r'[0-9.]')),
                                      ...
                                      Column(
                                        children: [
                                          ...
                                          Container(
                                            ...
                                            child: TextFormField(
                                              initialValue:   _listaFluidos[index]['cantidad'],
                                      ...
                                      Column(
                                        children: [
                                          ...
                                          Container(
                                            width: size.wScreen(15.0),
                                            child: TextFormField(
                                              initialValue:  _listaFluidos[index]['inicio'],
...
///===========================================//
            ...
            Text(
                '${_listaFluidos[index]['fluido']}-${_listaFluidos[index]['idFluido']}'),
          ],
        )),
        DataCell(Text(_listaFluidos[index]['dosis'])),
        DataCell(Text(_listaFluidos[index]['cantidad'])),
        // DataCell(Text(_listaFluidos[index]['via'])),
        DataCell(Text(_listaFluidos[index]['inicio'])),
  ...
  void _eliminaRow(int index) {
    context
        ...
        .eliminaFluidoAgregada(_listaFluidos[index]['idFluido']);
  }
  ...
  @override
  int get rowCount => _listaFluidos.length;
