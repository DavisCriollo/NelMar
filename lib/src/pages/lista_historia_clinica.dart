...
class ListaHistoriaClinica extends StatefulWidget {
  const ListaHistoriaClinica({Key? key}) : super(key: key);

  @override
  State<ListaHistoriaClinica> createState() => _ListaHistoriaClinicaState();
}

class _ListaHistoriaClinicaState extends State<ListaHistoriaClinica> {
                ...
                children: [
                  Expanded(
                    child: Container(
                      ...
                      child: (providerSearchHistorias.btnSearchHistorias)
                          ? ClipRRect(
                                      ...
                                      child: TextField(
                                        ...
                                        onChanged: (text) {
                                          providerSearchHistorias
                                              .onSearchTextHistorias(text);

                                          if (providerSearchHistorias
                                              .nameSearchHistorias.isEmpty) {
                                            providerSearchHistorias
                  ...
                  IconButton(
                      splashRadius: 2.0,
                      icon: (!providerSearchHistorias.btnSearchHistorias)
                          ? Icon(
                              Icons.search,
                      ...
                      onPressed: () {
                        providerSearchHistorias.setBtnSearchHistorias(
                            !providerSearchHistorias.btnSearchHistorias);
                        _textSearchController.text = "";
                        providerSearchHistorias.buscaAllHistoriasClinicas('');
                      }),
                ],
              );
            },
        ...
        body: Container(
          ...
          child:  Consumer<HistoriaClinicaController>(
                      builder: (_, providerHistorias, __) {
                        if (providerHistorias.getErrorHistorias == null &&
                            providerHistorias.getError401HistoriaClinica ==
                                false) {
                          return Center(
                        ...
                        } else if (providerHistorias.getErrorHistorias ==
                            false) {
                          return const NoData(
                        ...
                        else if (providerHistorias.getListaHistorias.isEmpty &&
                            providerHistorias.getError401HistoriaClinica ==
                                true) {
                          return const NoData(
                            label:
                        ...
                        return ListView.builder(
                          ...
                          itemCount: providerHistorias.getListaHistorias.length,
                          itemBuilder: (BuildContext context, int index) {
                            final historia =
                                providerHistorias.getListaHistorias[index];
                            return Slidable(
                              startActionPane: ActionPane(
                                ...
                                children: [
                                  ...
                                  //   onPressed: (context) {
                                  //     providerHistorias
                                  //         .setInfoHistoriaClinica(historia);

                                  //     Navigator.pushNamed(
                                  //         context, 'crearHistiriaClinica',
                                  //         arguments: 'EDIT');
                                  //   },
                                  // ),
                                  // SlidableAction(
          ...
          return CupertinoAlertDialog(
            ...
            content: Row(
              ...
              children: [
                TextButton(
                  onPressed: () {
                    _controller.eliminaHistoriaCinica(buildcontext, _id);
                    Navigator.pop(context);
                  },
                  child: Text(
                    'Aceptar',
