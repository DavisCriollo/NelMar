                  ...
                  children: [
                    Expanded(
                      child: Container(
                        ...
                        child: (providerSearchMascotas.btnSearchMascota)
                            ? ClipRRect(
                                        ...
                                        child: TextField(
                                          ...
                                          onChanged: (text) {
                                            providerSearchMascotas
                                                .onSearchTextMascota(text);

                                            if (providerSearchMascotas
                                                .nameSearchMascota.isEmpty) {
                                              providerSearchMascotas
                                                  .buscaAllMascotas('');
                                            }
                    ...
                    IconButton(
                        splashRadius: 2.0,
                        icon: (!providerSearchMascotas.btnSearchMascota)
                            ? Icon(
                                Icons.search,
                        ...
                        onPressed: () {
                          providerSearchMascotas.setBtnSearchMascota(
                              !providerSearchMascotas.btnSearchMascota);
                          _textSearchController.text = "";
                          providerSearchMascotas.buscaAllMascotas('');
                        }),
                  ],
                );
              },
            ...
            child:  Consumer<MascotasController>(
                        builder: (_, providerMascota, __) {
                          if (providerMascota.getErrorMascotas == null &&
                              providerMascota.getError401Mascotas == false) {
                            return Center(
                            ...
                            // Text("Error al cargar los datos");
                              ...
                              providerMascota.getError401Mascotas == true) {
                            return const NoData(
                              label:
